...
function getPercentages(){
  let index1 = cheerio.load(fs.readFileSync(process.env.ROOT_PATH + 'src/external/compiler/tesi/original-module/target/site/jacoco/index.html'));
  let index2 = cheerio.load(fs.readFileSync(process.env.ROOT_PATH + 'src/external/compiler/tesi/refactored-module/target/site/jacoco/index.html'))
  let index3 = cheerio.load(fs.readFileSync(process.env.ROOT_PATH + 'src/external/compiler/tesi/aggregate-reports/target/site/jacoco-aggregate/index.html'));
